...
__all__ = [
    '_ISpeechRecoContextEvents', 'SPWT_LEXICAL',
    'IInternetSecurityManager', 'ISpeechObjectToken',
    'SPSEMANTICERRORINFO', 'DISPID_SLWType', 'SPBO_TIME_UNITS',
    'DISPID_SPRulesCount', 'DISPID_SDKSetLongValue',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SVSpeakStream',
    'SPPROPERTYINFO', 'DISPID_SLPPhoneIds', 'SPWORDPRONUNCIATIONLIST',
    'SPPS_RESERVED3', 'SpFileStream', 'ISpeechLexiconPronunciation',
    'DISPID_SRGetFormat', 'DISPID_SLPs_NewEnum', 'SAFT12kHz16BitMono',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SRAInterpreter', 'ISpeechPhraseElements',
    'DISPID_SPRuleNumberOfElements', 'SVEWordBoundary',
    'SSSPTRelativeToEnd', 'SPPARTOFSPEECH', 'SAFT32kHz8BitStereo',
    'DISPID_SGRAddResource', 'DISPID_SLGetGenerationChange',
    'SITooFast', 'SpeechRegistryUserRoot',
    'SPEI_PROPERTY_STRING_CHANGE', 'DISPID_SOTGetStorageFileName',
    'SpMemoryStream', 'DISPID_SRIsShared', 'SAFT11kHz16BitStereo',
    'DISPID_SWFESamplesPerSec', 'DISPID_SRAudioInputStream',
    'SRCS_Disabled', 'SPPS_SuppressWord',
    'DISPID_SpeechPhraseAlternates', 'ISpPhoneticAlphabetSelection',
    'SpInprocRecognizer', 'SpObjectTokenCategory',
    'SPINTERFERENCE_TOOQUIET', 'DISPID_SLPPartOfSpeech', 'SGRSTTRule',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'DISPID_SPAsItem', 'SpeechRecognizerState',
    'ISpeechPhraseAlternates', 'ISpRecognizer', 'SPWORDPRONUNCIATION',
    'SGDisplay', 'DISPID_SRSSupportedLanguages',
    'SpInProcRecoContext', 'SPEI_UNDEFINED', 'DISPID_SpeechVoice',
    'SPRECOGNIZERSTATUS', 'DISPID_SGRSTType', 'SPWF_SRENGINE',
    'DISPID_SRState', 'SPFM_OPEN_READWRITE',
    'SAFTTrueSpeech_8kHz1BitMono', 'DISPID_SVAudioOutputStream',
    'tagSTATSTG', 'SPAUDIOBUFFERINFO', 'DISPID_SDKGetlongValue',
    'DISPID_SVSLastBookmark', 'SREBookmark',
    'DISPID_SABIMinNotification', 'SP_VISEME_7',
    'DISPID_SGRsCommitAndSave', 'DISPID_SPPs_NewEnum',
    'DISPID_SPRuleEngineConfidence', 'SPVPRIORITY',
    'DISPID_SpeechPhraseBuilder', 'ISpRecoContext',
    'DISPID_SVGetAudioInputs', 'SPPS_Noncontent',
    'DISPID_SpeechRecoContextEvents', 'DISPID_SPRDisplayAttributes',
    'DISPID_SVSInputWordPosition', 'SPEI_RECO_OTHER_CONTEXT',
    'SAFTCCITT_ALaw_22kHzMono', 'DISPIDSPTSI_ActiveLength',
    'DISPID_SGRsCommit', 'SPEI_SOUND_END',
    'DISPID_SGRSAddWordTransition', 'DISPID_SDKDeleteKey',
    'SpeechCategoryRecognizers', 'SpeechCategoryPhoneConverters',
    'SpeechGrammarTagWildcard', 'ISpeechLexiconWords', 'UINT_PTR',
    'eLEXTYPE_PRIVATE10', 'DISPID_SRRSaveToMemory',
    'SpeechVisemeType', 'DISPIDSPTSI_SelectionLength',
    'ISpeechLexiconWord', 'eLEXTYPE_PRIVATE19', 'SRSEIsSpeaking',
    'SAFT22kHz8BitStereo', 'DISPID_SGRSTsItem',
    'DISPID_SAFGetWaveFormatEx', 'SPSLMA', 'SPEI_MIN_SR',
    'SpeechGrammarTagDictation',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SLGenerationId', 'SPEI_RECO_STATE_CHANGE', 'SITooSlow',
    'SAFT24kHz16BitStereo', 'eLEXTYPE_USER', 'DISPID_SRRAlternates',
    'ISpeechRecoResult', 'SDKLDefaultLocation', 'SRCS_Enabled',
    'ISpeechVoiceStatus', 'DISPID_SRAudioInput',
    'ISpeechObjectTokenCategory', 'DISPID_SRGSetTextSelection',
    'eLEXTYPE_RESERVED8', 'SAFT22kHz8BitMono',
    'DISPID_SpeechAudioFormat', 'DISPID_SVWaitUntilDone',
    'DISPID_SRRPhraseInfo', 'SP_VISEME_3', 'DISPID_SGRsDynamic',
    'SPEI_MAX_TTS', 'DISPID_SpeechPhraseElement',
    'DISPID_SRCEHypothesis', 'DISPID_SVSkip', 'ISpeechRecoResult2',
    'SAFTADPCM_44kHzStereo', 'SVP_2', 'SASPause', 'ISpMMSysAudio',
    'SPAS_RUN', 'SVP_3', 'DISPID_SRRSetTextFeedback',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'DISPID_SGRSTText',
    'SPSHT_OTHER', 'SVP_8', 'DISPID_SGRSTPropertyName',
    'DISPID_SPIGetDisplayAttributes', 'SAFTCCITT_ALaw_44kHzMono',
    'DISPID_SpeechPhraseRule', 'SpeechLexiconType',
    'SPSHT_NotOverriden', 'SPEI_RESERVED3', 'eLEXTYPE_PRIVATE2',
    'SpeechAudioVolume', 'SVPNormal', 'DISPID_SGRsFindRule',
    'SAFTGSM610_11kHzMono', 'DISPID_SRCEAdaptation', 'SPLO_STATIC',
    'DISPID_SOTsCount', 'SVSFlagsAsync', 'eLEXTYPE_PRIVATE6',
    'SpeechInterference', 'SVESentenceBoundary', 'SAFT48kHz8BitMono',
    'SPINTERFERENCE_NOISE', 'SpeechTokenShellFolder',
    'SpWaveFormatEx', 'SpAudioFormat', 'SSFMOpenForRead',
    'SpCompressedLexicon', 'DISPID_SGRsCount',
    'DISPID_SVSLastBookmarkId', 'SDKLCurrentConfig',
    'DISPID_SRGetPropertyNumber', 'ISpeechAudioFormat',
    'DISPID_SBSWrite', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SRStatus',
    'SP_VISEME_4', 'SPWT_DISPLAY',
    'SpeechPropertyNormalConfidenceThreshold', 'SVP_10',
    'SAFTExtendedAudioFormat', 'DISPID_SRCERecognition',
    'DISPID_SpeechCustomStream', 'SPEI_SR_BOOKMARK',
    'DISPID_SpeechMemoryStream', 'DISPID_SPIAudioSizeTime', 'SVP_14',
    'SAFT48kHz16BitMono', 'DISPID_SpeechLexiconWord', 'SINoise',
    'DISPID_SPRuleFirstElement', 'SRTExtendableParse', 'SPBO_PAUSE',
    'SPPHRASEELEMENT', 'SPEI_SR_RETAINEDAUDIO', 'ISpPhraseAlt',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SOTCategory',
    'DISPID_SGRAttributes', 'SpeechDictationTopicSpelling',
    'DISPID_SPANumberOfElementsInResult', 'SPEVENTENUM',
    'DISPID_SRRecognizer', 'SAFT24kHz8BitMono', 'ISpeechMMSysAudio',
    'DISPID_SRCEventInterests', 'DISPID_SpeechAudio', 'SPAUDIOSTATE',
    'SPEI_INTERFERENCE', 'DISPID_SRCEBookmark', 'SVP_5',
    'DISPID_SRRGetXMLResult', 'DISPID_SRCCreateResultFromMemory',
    'SRTReSent', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRCEPhraseStart', 'SpeechLoadOption',
    'SpeechAddRemoveWord', 'eLEXTYPE_PRIVATE7', 'DISPID_SPACommit',
    'SPDATAKEYLOCATION', 'eLEXTYPE_USER_SHORTCUT',
    'DISPID_SPIGetText', 'SPAUDIOOPTIONS', 'SPXRO_SML',
    'ISpeechLexicon', 'DISPID_SLPsItem', 'SPSHT_Unknown',
    'ISpResourceManager', 'DISPID_SPEAudioSizeBytes',
    'DISPID_SRSAudioStatus', 'DISPID_SOTDisplayUI',
    'DISPID_SPIGrammarId', 'DISPID_SpeechRecoContext',
    'ISpProperties', 'SPPS_Noun', 'SPLEXICONTYPE', 'SPSModifier',
    'SAFT16kHz8BitMono', 'SPEI_SOUND_START', 'SpeechStreamFileMode',
    'SPFM_NUM_MODES', 'DISPID_SAStatus', 'SPBO_NONE',
    'SAFTNonStandardFormat', 'DISPID_SPERetainedSizeBytes',
    'SpeechAllElements', 'SVP_18', 'SpeechAudioState',
    ...
    'SPCT_SLEEP', 'DISPID_SRCSetAdaptationData', 'SVP_21',
    'SVSFNLPSpeakPunc', 'SRTAutopause', 'SAFT12kHz16BitStereo',
    'SDTAlternates', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SGRsAdd', 'SpMMAudioIn', 'SPEI_TTS_AUDIO_LEVEL',
    'SRADynamic', 'SpTextSelectionInformation', 'DISPID_SVEPhoneme',
    'DISPID_SVAudioOutput', 'DISPID_SPEActualConfidence',
    'SSFMOpenReadWrite', '_RemotableHandle', 'SPWF_INPUT',
    'SpNotifyTranslator', 'SpSharedRecognizer', 'SPAR_High',
    'DISPID_SVEWord', 'SpeechPropertyAdaptationOn',
    'SAFT24kHz16BitMono', 'eLEXTYPE_PRIVATE12', 'SRARoot',
    'SpeechGrammarRuleStateTransitionType', 'DISPID_SMSGetData',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SPPNumberOfElements',
    'ISpeechObjectTokens', 'eLEXTYPE_PRIVATE1', 'SLTApp',
    'SPTEXTSELECTIONINFO', 'DISPID_SOTCEnumerateTokens',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'DISPID_SOTSetId',
    'DISPID_SPPEngineConfidence', 'ISpRecognizer2', 'SRAORetainAudio',
    'SAFT48kHz8BitStereo', 'DISPID_SRCESoundStart', 'SVP_7',
    'SVF_Emphasis', 'SVP_17', 'DISPID_SRRAudioFormat',
    'DISPID_SPRules_NewEnum', 'SPVPRI_NORMAL',
    'SAFTCCITT_uLaw_22kHzStereo', 'SPADAPTATIONRELEVANCE',
    'DISPID_SRSetPropertyNumber', 'SPBO_AHEAD', 'DISPID_SMSALineId',
    'DISPID_SPAs_NewEnum', 'DISPID_SPEPronunciation',
    'DISPID_SDKGetBinaryValue', 'SGRSTTDictation',
    'SpeechPropertyLowConfidenceThreshold', 'SECFIgnoreWidth',
    'ISpVoice', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SDKSetStringValue', 'SECLowConfidence',
    'DISPID_SRGIsPronounceable', 'SAFTCCITT_uLaw_8kHzStereo',
    'DISPID_SPERequiredConfidence', 'DISPID_SMSAMMHandle',
    'SPPS_RESERVED2', 'SpeechRetainedAudioOptions', 'DISPID_SOTCId',
    'DISPID_SPPConfidence', 'ISpeechRecoGrammar',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SpeechFileStream',
    'eWORDTYPE_DELETED', 'SpShortcut', 'DISPID_SRCERequestUI',
    'DISPID_SpeechWaveFormatEx', 'SRTStandard',
    'DISPID_SWFEAvgBytesPerSec', 'ISpRecoContext2',
    'SPSEMANTICFORMAT', 'SP_VISEME_0', 'DISPID_SpeechLexicon',
    'SPCONTEXTSTATE', 'DISPID_SRCEPropertyStringChange',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SPIReplacements',
    'DISPID_SPAPhraseInfo', 'SPPS_Function', 'SPEI_TTS_BOOKMARK',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRSTs_NewEnum',
    'eLEXTYPE_LETTERTOSOUND', 'ISpeechFileStream',
    'SVSFPurgeBeforeSpeak', 'SPPHRASERULE', 'DISPID_SPCPhoneToId',
    'SPPS_Unknown', 'DISPID_SRProfile', 'SPGRAMMARSTATE',
    'DISPID_SPIEngineId', 'SpObjectToken', 'SVP_6', 'DISPID_SOTsItem',
    'DISPID_SLWsCount', 'SVEViseme', 'DISPID_SRGReset',
    'Speech_StreamPos_RealTime', 'DISPID_SpeechBaseStream',
    'DISPID_SAEventHandle', 'SPRECORESULTTIMES', 'SVP_15',
    'SGRSTTEpsilon', 'ISpeechPhraseReplacement', 'SPGRAMMARWORDTYPE',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SGRInitialState',
    'SPEI_RESERVED5', 'SLTUser', 'SPRULESTATE', 'DISPID_SVPriority',
    'SAFT22kHz16BitMono', 'DISPID_SPRsCount',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SPIRetainedSizeBytes',
    'eLEXTYPE_PRIVATE4', 'SFTInput', 'DISPID_SPRuleName', 'SPPS_Verb',
    'SAFT32kHz8BitMono', 'eLEXTYPE_RESERVED9', 'SPEI_SR_AUDIO_LEVEL',
    'SAFT8kHz16BitStereo', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'DISPID_SVGetVoices', 'SpUnCompressedLexicon',
    'DISPID_SMSSetData', 'eLEXTYPE_PRIVATE3',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SVSInputSentencePosition',
    'DISPID_SpeechObjectToken', 'eLEXTYPE_MORPHOLOGY',
    'DISPID_SPRText', 'SPVOICESTATUS', 'SAFT44kHz8BitMono',
    'SP_VISEME_13', 'DISPID_SPEsCount', 'eLEXTYPE_PRIVATE5',
    'DISPID_SPPParent', 'DISPID_SLGetWords', 'ISpeechGrammarRules',
    'SPCS_DISABLED', 'IEnumSpObjectTokens',
    'DISPID_SAFSetWaveFormatEx', 'SAFT44kHz16BitStereo',
    'SWPUnknownWordPronounceable', 'SPSFunction',
    'SPSERIALIZEDRESULT', 'SREStateChange',
    'DISPID_SPRNumberOfElements', 'ISpeechGrammarRule',
    'SRERecognition', 'SGLexical', 'SGRSTTTextBuffer',
    'DISPID_SpeechRecognizer', 'DISPID_SPIRule', 'DISPID_SAFType',
    'SPSHT_EMAIL', 'SPVISEMES', 'SpeechAudioProperties',
    'DISPID_SWFEChannels', 'SpNullPhoneConverter',
    'SpPhraseInfoBuilder', 'SPEI_TTS_PRIVATE', 'SPEI_END_SR_STREAM',
    'SSTTDictation', 'DISPID_SPEDisplayAttributes',
    'SAFT8kHz8BitStereo', 'SVSFParseSsml', 'DISPID_SBSSeek',
    'DISPID_SBSFormat', 'SINoSignal', 'DISPID_SREmulateRecognition',
    'ISpeechPhraseReplacements', 'ISpeechAudioBufferInfo',
    'SpeechEmulationCompareFlags', 'DISPID_SRGetPropertyString',
    'DISPID_SAVolume', 'SpeechGrammarTagUnlimitedDictation', 'SPWORD',
    'SpeechBookmarkOptions', 'Speech_Max_Pron_Length',
    'SPLOADOPTIONS', 'SpeechRecoEvents', 'DISPID_SOTs_NewEnum',
    'IEnumString', 'SDA_No_Trailing_Space', 'SpeechDataKeyLocation',
    'SPEI_START_SR_STREAM', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SCSBaseStream', 'DISPID_SpeechLexiconProns', 'SINone',
    'eLEXTYPE_VENDORLEXICON', 'SVSFDefault', 'SPWORDLIST',
    'DISPID_SRRTStreamTime', 'DISPID_SRSetPropertyString',
    'DISPID_SASNonBlockingIO', 'SPEI_MIN_TTS',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpStreamFormatConverter',
    'DISPID_SOTGetAttribute', 'SVEEndInputStream',
    'eLEXTYPE_PRIVATE11', 'SAFT12kHz8BitMono', 'SpeechTokenContext',
    'SREAllEvents', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SpeechRecoResult', 'SpLexicon',
    'ISpeechLexiconPronunciations', 'SPWORDPRONOUNCEABLE', 'SBONone',
    'SPEI_ADAPTATION', 'DISPID_SRCESoundEnd', 'DISPID_SVSVisemeId',
    'SPCS_ENABLED', 'ISpeechPhoneConverter', 'SPBOOKMARKOPTIONS',
    'DISPID_SRGRecoContext', 'SASClosed',
    'ISpeechGrammarRuleStateTransition', 'SP_VISEME_12', 'SBOPause',
    'ISpRecoGrammar2', 'SRSInactiveWithPurge',
    'DISPID_SpeechGrammarRule', 'SVSFIsXML', 'DISPID_SWFEBlockAlign',
    'SPINTERFERENCE_TOOSLOW', 'ISpeechPhraseAlternate',
    'SpeechTokenKeyAttributes', 'SAFTCCITT_ALaw_8kHzStereo',
    'DISPID_SGRClear', 'DISPID_SRRDiscardResultInfo',
    'SpeechVisemeFeature', 'DISPID_SWFEFormatTag',
    'DISPID_SPAStartElementInResult', 'SASRun', 'SDTAll',
    'SDKLLocalMachine', 'SWTDeleted',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SPRuleId',
    'SPPS_NotOverriden', 'SVPOver', 'SDTRule', 'DISPID_SRRSpeakAudio',
    'DISPID_SpeechAudioStatus', 'DISPID_SLAddPronunciationByPhoneIds',
    'SVEVoiceChange', 'SAFTADPCM_8kHzStereo',
    'SGDSActiveUserDelimited', 'DISPID_SpeechLexiconWords',
    'SPAS_CLOSED', 'SAFTCCITT_ALaw_8kHzMono', 'SPWORDTYPE',
    'DISPID_SVSLastResult', 'SP_VISEME_17', 'SVSFUnusedFlags',
    'STSF_LocalAppData', 'SVP_9', 'ISpeechCustomStream',
    'SAFTADPCM_11kHzStereo', 'DISPID_SOTGetDescription',
    'DISPID_SOTCGetDataKey', 'SPPHRASEPROPERTY',
    'DISPID_SWFEExtraData', 'DISPID_SRGDictationLoad',
    'SAFT22kHz16BitStereo', 'DISPID_SpeechPhraseReplacements',
    'DISPID_SPPName', 'DISPID_SVSCurrentStreamNumber', 'ISpPhrase',
    'SP_VISEME_6', 'DISPID_SPELexicalForm',
    'DISPID_SWFEBitsPerSample', 'DISPID_SAFGuid',
    '__MIDL_IWinTypes_0009', 'SpeechAudioFormatType', 'ISpNotifySink',
    'SpeechRegistryLocalMachineRoot', 'SAFT11kHz8BitMono',
    'ISpLexicon', 'DISPID_SMSADeviceId', 'SpeechCategoryRecoProfiles',
    'SREStreamStart', 'SAFTCCITT_uLaw_11kHzStereo',
    'DISPID_SDKDeleteValue', 'SAFTText',
    'DISPID_SASCurrentSeekPosition', 'SAFTADPCM_8kHzMono',
    'DISPID_SPEEngineConfidence', 'DISPID_SLWLangId',
    'SpeechTokenKeyFiles', 'SRSEDone', 'DISPID_SPISaveToMemory',
    'ISpRecoCategory', 'ISpeechVoice', 'DISPID_SDKEnumValues',
    'SWPUnknownWordUnpronounceable', 'DISPID_SLAddPronunciation',
    'SPWT_PRONUNCIATION', 'DISPID_SRSClsidEngine',
    'SPSTREAMFORMATTYPE', 'ISpAudio', 'SPEI_HYPOTHESIS',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SVEventInterests',
    'DISPID_SGRSAddRuleTransition', 'SpeechVoiceEvents',
    'DISPID_SVStatus', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRRTTickCount', 'DISPID_SGRSTPropertyValue',
    'SPEI_VISEME', 'SDA_One_Trailing_Space', 'DISPID_SPRsItem',
    'ISpNotifyTranslator', 'DISPID_SRCVoicePurgeEvent',
    'eLEXTYPE_APP', 'SP_VISEME_16', 'ISpStream', 'SVPAlert',
    'SpVoice', 'DISPID_SpeechPhraseReplacement', 'SASStop',
    'SECFIgnoreCase', 'SREPrivate', 'DISPID_SRRTLength',
    'DISPID_SVGetAudioOutputs', 'SpMMAudioOut', 'SGRSTTWildcard',
    'ISpRecoGrammar', 'DISPID_SVResume', 'DISPID_SRCRecognizer',
    'SVEAudioLevel', 'SPDKL_LocalMachine',
    'DISPID_SRSCurrentStreamNumber', 'SAFT32kHz16BitMono',
    'ISpeechMemoryStream', 'SREHypothesis', 'eLEXTYPE_PRIVATE8',
    'DISPID_SPIStartTime', 'DISPID_SRCEFalseRecognition',
    'DISPID_SVIsUISupported', 'DISPID_SpeechVoiceEvent', 'SPEVENT',
    'SVP_19', 'SpeechRecognitionType', 'SVEStartInputStream',
    'DISPID_SpeechGrammarRules',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'ISpObjectTokenCategory', 'ISpeechPhraseInfoBuilder',
    'ISpeechDataKey', 'LONG_PTR', 'SPPS_LMA', 'SPSNotOverriden',
    'DISPID_SOTMatchesAttributes', 'DISPID_SGRSTRule',
    'DISPID_SPRuleChildren', 'SAFT11kHz16BitMono',
    'IInternetSecurityMgrSite', 'SPEI_RESERVED1',
    'DISPID_SADefaultFormat', 'ISpeechPhraseProperties',
    'SVF_Stressed', 'SpeechPropertyComplexResponseSpeed',
    'tagSPTEXTSELECTIONINFO', 'SPCT_DICTATION',
    'DISPID_SRGCmdLoadFromMemory', 'SAFTADPCM_11kHzMono',
    'DISPID_SGRSTNextState', 'SP_VISEME_1', 'SRSActiveAlways',
    'SPEI_MAX_SR', 'DISPID_SRGState', 'ISpeechPhraseProperty',
    'DISPID_SRCResume', 'SDTDisplayText', 'ISpeechPhraseRule',
    'DISPID_SOTDataKey', 'DISPID_SRGetRecognizers', 'SFTSREngine',
    'SECFIgnoreKanaType', 'SSFMCreate', 'DISPID_SPILanguageId',
    'DISPID_SASState', 'SAFT16kHz16BitStereo', '_ISpeechVoiceEvents',
    'SPSHORTCUTTYPE', 'eLEXTYPE_PRIVATE20', 'SAFT11kHz8BitStereo',
    'SITooLoud', 'DISPID_SVSRunningState', 'SRTEmulated',
    'SVEBookmark', 'SVSFPersistXML', 'SGSEnabled', 'SPSMF_UPS',
    'DISPID_SRCEEnginePrivate', 'SDTPronunciation', 'SVEAllEvents',
    'DISPID_SDKOpenKey', 'DISPID_SRRTimes', 'DISPID_SPRs_NewEnum',
    'SpeechVoiceSpeakFlags', 'SPAUDIOSTATUS',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRGCmdLoadFromFile',
    'SPSSuppressWord', 'SAFT8kHz8BitMono',
    'DISPID_SLGetPronunciations', 'ISpShortcut', 'DISPID_SRCVoice',
    'ISpNotifySource', 'SPSMF_SAPI_PROPERTIES', 'SDTReplacement',
    'DISPID_SRCEStartStream', 'DISPID_SFSOpen',
    'SAFTCCITT_ALaw_11kHzStereo', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPPsItem', 'DISPID_SLPLangId', 'DISPID_SVGetProfiles',
    'SpeechRunState', 'SPEI_VOICE_CHANGE', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SpeechLexiconPronunciation', 'SWPKnownWordPronounceable',
    'SpeechAudioFormatGUIDText', 'DISPID_SLPsCount', 'SDTLexicalForm',
    'DISPID_SLPSymbolic', 'SREPropertyStringChange',
    'eWORDTYPE_ADDED', 'DISPID_SpeechPhraseRules',
    'SPEI_FALSE_RECOGNITION', 'SREAdaptation',
    'DISPID_SpeechRecoResult2', 'SPCATEGORYTYPE', 'SVP_12',
    'SPAR_Unknown', 'SP_VISEME_15', 'DISPID_SVEVoiceChange',
    'DISPID_SVSpeak', 'SDTAudio', 'SRADefaultToActive',
    'ISpeechGrammarRuleState',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SVF_None',
    'SPGS_DISABLED', 'SPCT_SUB_COMMAND', 'SpeechUserTraining',
    'SpeechSpecialTransitionType', 'ISpeechXMLRecoResult',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPPS_Modifier', 'STSF_CommonAppData',
    'SP_VISEME_18', 'SPSHORTCUTPAIR', 'eLEXTYPE_RESERVED6',
    'ISequentialStream', 'SPXMLRESULTOPTIONS', 'DISPID_SPRulesItem',
    'SPEI_PHRASE_START', 'ISpObjectToken', 'DISPID_SRDisplayUI',
    'DISPID_SRCEEndStream', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SRIsUISupported', 'DISPID_SLWsItem', 'SGRSTTWord',
    'SPSUnknown', 'SP_VISEME_19', 'SPAR_Low', 'DISPID_SPEs_NewEnum',
    'DISPID_SPPFirstElement', 'SPEI_RECOGNITION', 'STSF_AppData',
    'SpeechDiscardType', 'ISpeechPhraseElement',
    'DISPID_SDKCreateKey', 'SSTTTextBuffer', 'DISPID_SPRuleParent',
    'SPSInterjection', 'SPINTERFERENCE_NONE', 'SREPhraseStart',
    'SpeechGrammarWordType', 'DISPID_SPPValue', 'SRESoundEnd',
    'SPFM_CREATE_ALWAYS', 'SpPhoneConverter', 'SSTTWildcard',
    'SPPS_RESERVED1', 'DISPID_SGRs_NewEnum', 'SpeechVoicePriority',
    'SDTProperty', 'SAFT16kHz16BitMono', 'SAFTCCITT_uLaw_44kHzMono',
    'DISPID_SRCPause', 'DISPID_SpeechPhraseInfo', 'SPRS_ACTIVE',
    'SPAO_RETAIN_AUDIO', 'DISPID_SLPType',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRGSetWordSequenceData',
    'DISPID_SASCurrentDevicePosition', 'SVP_13',
    'Speech_StreamPos_Asap', 'SPSHORTCUTPAIRLIST', 'SRESoundStart',
    'SAFT32kHz16BitStereo', 'DISPID_SRCBookmark',
    'DISPID_SRGDictationUnload', 'SPGS_EXCLUSIVE',
    'SpeechCategoryAudioOut', 'SAFT16kHz8BitStereo',
    'DISPID_SPIAudioSizeBytes', 'DISPID_SABIBufferSize',
    'SPFM_CREATE', 'SpeechVoiceSkipTypeSentence', 'SVP_16',
    'DISPID_SDKGetStringValue', 'DISPID_SRCEAudioLevel',
    'SAFTADPCM_44kHzMono', 'DISPID_SVPause', 'SRERequestUI',
    'SPDKL_CurrentConfig', 'STCAll', 'SREFalseRecognition',
    'DISPID_SOTCSetId', 'SVEPhoneme', 'DISPID_SLWs_NewEnum',
    'DISPID_SVEStreamEnd', 'SRAONone', 'DISPID_SpeechPhraseAlternate',
    'SpeechGrammarState', 'SpeechPropertyResponseSpeed',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSTransitions',
    'SpeechCategoryVoices', 'SECFDefault', 'SPWAVEFORMATTYPE',
    'SPEI_START_INPUT_STREAM', 'SDA_Two_Trailing_Spaces',
    'SpCustomStream', 'DISPID_SRCRequestedUIType',
    'DISPID_SRCreateRecoContext', 'DISPID_SPIProperties',
    'DISPID_SVEViseme', 'eLEXTYPE_PRIVATE16', 'SAFTGSM610_22kHzMono',
    'ISpObjectWithToken', 'SPPHRASE', 'DISPID_SPEAudioSizeTime',
    'SpeechRecoContextState', 'DISPID_SVSInputWordLength',
    'ISpeechPhraseRules', 'SAFT48kHz16BitStereo', 'SpResourceManager',
    'SAFTDefault', 'SECFEmulateResult', 'SPFILEMODE', 'SVP_11',
    'SPEI_REQUEST_UI', 'SP_VISEME_10', 'SLODynamic', 'SPINTERFERENCE',
    'DISPID_SPIEnginePrivateData', 'SP_VISEME_5',
    'DISPID_SDKEnumKeys', 'DISPID_SVAlertBoundary',
    'DISPID_SpeechDataKey', 'SPDKL_CurrentUser', 'SRATopLevel',
    'SpeechStreamSeekPositionType', 'SpeechFormatType', 'SPAS_PAUSE',
    'DISPID_SPCIdToPhone', 'DISPID_SRCERecognitionForOtherContext',
    'SAFTCCITT_ALaw_22kHzStereo', 'ISpSerializeState',
    'ISpRecognizer3', 'DISPID_SVVoice',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SRCCreateGrammar',
    'DISPID_SGRId', 'DISPID_SRGCmdLoadFromObject',
    'SpeechDisplayAttributes', 'DISPID_SpeechPhraseElements',
    'SP_VISEME_9', 'SPEI_RESERVED6', 'SAFTADPCM_22kHzMono',
    'DISPID_SVSpeakCompleteEvent', 'SECHighConfidence',
    'ISpPhoneticAlphabetConverter', 'SPFM_OPEN_READONLY',
    'DISPID_SPARecoResult', 'DISPID_SPEAudioTimeOffset',
    'SGDSInactive', 'SPEVENTSOURCEINFO', 'DISPID_SDKSetBinaryValue',
    'SPEI_SENTENCE_BOUNDARY', 'ISpeechPhraseInfo',
    'SAFT12kHz8BitStereo', 'ISpGrammarBuilder',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SPRST_NUM_STATES', 'DISPID_SVVolume', 'SPPS_RESERVED4',
    'SGDSActive', 'SPAS_STOP', 'DISPID_SVSInputSentenceLength',
    'SGSDisabled', 'SPDKL_DefaultLocation', 'ISpXMLRecoResult',
    'tagSPPROPERTYINFO', 'DISPID_SPPChildren',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SPRFirstElement',
    'SVSFParseSapi', 'DISPID_SGRSRule', 'SPAO_NONE',
    'DISPID_SVEStreamStart', 'ISpRecoResult', 'SVSFParseAutodetect',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SRGCmdLoadFromResource', 'eLEXTYPE_RESERVED4',
    'STCLocalServer', 'DISPID_SABufferInfo',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPPHRASEREPLACEMENT',
    'SVSFNLPMask', 'SPLO_DYNAMIC', 'DISPID_SOTIsUISupported',
    'SGLexicalNoSpecialChars', 'SPEI_END_INPUT_STREAM',
    'SPINTERFERENCE_LATENCY_WARNING', 'SGDSActiveWithAutoPause',
    'DISPID_SPPsCount', 'SPRECOCONTEXTSTATUS',
    'DISPID_SLRemovePronunciation', 'SWTAdded',
    'ISpeechResourceLoader', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'eLEXTYPE_PRIVATE18', 'SAFT24kHz8BitStereo', 'DISPID_SGRAddState',
    'SSFMCreateForWrite', 'DISPID_SRGCmdSetRuleIdState',
    'DISPIDSPTSI', 'DISPID_SRGDictationSetState', 'IStream',
    'SRAExport', 'Speech_Max_Word_Length', 'SAFT8kHz16BitMono',
    'DISPID_SpeechPhraseProperty', 'SRSActive',
    'DISPID_SRSNumberOfActiveRules', 'DISPID_SGRSTPropertyId',
    'SPSNoun', 'DISPID_SpeechVoiceStatus', 'SPRULE', 'SPRS_INACTIVE',
    'SP_VISEME_14', 'SREPropertyNumChange', 'SP_VISEME_8',
    'Speech_Default_Weight', 'SpeechRuleState', 'SREStreamEnd',
    'SpeechWordPronounceable', 'STCRemoteServer', 'DISPID_SPAsCount',
    '_SPAUDIOSTATE', 'SAFT44kHz8BitStereo', 'ISpEventSink',
    'STCInprocHandler', 'DISPID_SABIEventBias',
    'SAFTGSM610_44kHzMono', 'DISPIDSPTSI_ActiveOffset',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVSPhonemeId',
    'DISPID_SVEAudioLevel', 'SPPS_Interjection',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'ISpeechRecoResultDispatch', 'DISPID_SOTCDefault',
    'DISPID_SpeechXMLRecoResult', 'DISPID_SRRAudio',
    'SAFTNoAssignedFormat', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SpPhoneticAlphabetConverter', 'DISPID_SLWPronunciations',
    'SVP_4', 'SSSPTRelativeToStart', 'SECNormalConfidence',
    'DISPID_SRGCmdSetRuleState', 'SPGS_ENABLED',
    'SpeechTokenValueCLSID', 'WAVEFORMATEX', 'DISPID_SRGId',
    'SpeechCategoryAppLexicons', 'SRTSMLTimeout',
    'ISpeechRecognizerStatus', 'DISPID_SOTRemove', 'SPAR_Medium',
    'SREAudioLevel', 'SECFNoSpecialChars',
    'SpeechPropertyHighConfidenceThreshold',
    'SpeechRecoProfileProperties', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechPropertyResourceUsage', 'DISPID_SVSLastStreamNumberQueued',
    'DISPID_SPRuleConfidence', 'eLEXTYPE_PRIVATE9',
    'DISPID_SpeechRecognizerStatus', 'SVSFVoiceMask', 'SVEPrivate',
    'SPRECOSTATE', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_WORD_BOUNDARY', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SVRate',
    'DISPID_SPEsItem', 'DISPID_SBSRead', 'SGSExclusive', 'ISpDataKey',
    'SPRST_ACTIVE', 'SpeechMicTraining',
    'DISPID_SpeechPhraseProperties', 'DISPID_SGRName',
    'SDA_Consume_Leading_Spaces', 'ISpeechWaveFormatEx',
    'DISPID_SOTId', 'SAFTGSM610_8kHzMono', 'SpeechRuleAttributes',
    'DISPID_SVEBookmark', 'DISPID_SRCRetainedAudio', 'SVSFParseMask',
    'DISPID_SVDisplayUI', 'DISPID_SPIElements', 'SRAImport',
    'DISPID_SGRSTsCount', 'SPRST_INACTIVE', 'SpeechWordType',
    'SRERecoOtherContext', 'eLEXTYPE_RESERVED10', 'SLOStatic',
    'ISpeechRecoContext', 'DISPID_SPPId', 'SPVPRI_OVER',
    'SpeechTokenIdUserLexicon', 'SPSVerb',
    'DISPID_SpeechObjectTokens', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SFSClose', 'SpStreamFormatConverter', 'SDKLCurrentUser',
    'SAFT44kHz16BitMono', 'SpeechEngineProperties', 'SREInterference',
    'ISpeechRecognizer', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SASetState', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPEDisplayText', 'SGPronounciation', 'ISpPhoneConverter',
    'DISPID_SASFreeBufferSpace', 'SP_VISEME_21', 'DISPID_SRGRules',
    'DISPID_SpeechGrammarRuleStateTransition', 'SVP_20',
    'SpeechTokenKeyUI', 'SPEI_SR_PRIVATE', 'SPXRO_Alternates_SML',
    'SPRS_ACTIVE_USER_DELIMITED', 'SpeechVoiceCategoryTTSRate',
    'DISPIDSPRG', 'SpeechPartOfSpeech', 'SPEI_RESERVED2',
    'DISPID_SRCEInterference', 'SVP_1', 'DISPID_SLWWord',
    'SPBINARYGRAMMAR', 'SpMMAudioEnum', 'SITooQuiet', 'SPEI_PHONEME',
    'ISpeechAudioStatus', 'SP_VISEME_20', 'eLEXTYPE_RESERVED7',
    'SP_VISEME_11', 'ISpeechTextSelectionInformation',
    'SPINTERFERENCE_TOOFAST', 'DISPID_SGRsItem', 'ISpStreamFormat',
    'DISPID_SpeechRecoResultTimes', 'DISPID_SABufferNotifySize',
    'SPSERIALIZEDPHRASE', 'SpeechCategoryAudioIn',
    'eLEXTYPE_PRIVATE14', 'DISPID_SRRRecoContext',
    'SpeechAudioFormatGUIDWave', 'SAFTCCITT_uLaw_11kHzMono',
    'SpStream', 'STCInprocServer', 'SP_VISEME_2', 'SVSFIsNotXML',
    'SAFTCCITT_uLaw_22kHzMono', 'DISPID_SOTCreateInstance',
    'DISPID_SRCState', 'ISpeechAudio', 'DISPID_SGRSTWeight',
    'ISpEventSource', 'DISPID_SRSCurrentStreamPosition',
    'STSF_FlagCreate', 'DISPID_SRGCommit', 'SPVPRI_ALERT',
    'DISPID_SPCLangId', 'SPCT_SUB_DICTATION', 'eLEXTYPE_PRIVATE17',
    'SVP_0', 'SPCT_COMMAND', 'SRSInactive',
    'DISPID_SPERetainedStreamOffset', 'SVSFIsFilename',
    'ISpeechBaseStream'
]
